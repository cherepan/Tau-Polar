...
#	system(sprintf("cd $PWD/$tauoladir/tauola++/1.1.5/examples; make"));
	...
	system(sprintf("cp UserCodes/TauHelper.cc $PWD/$tauoladir/tauola++/1.1.5/examples/UserCodes; "));
	system(sprintf("cp UserCodes/TauHelper.h $PWD/$tauoladir/tauola++/1.1.5/examples/UserCodes; "));
